...
def main(args):
    ...
    #calculating volume in tocon condition
    ...
    #def assign_equations(df, equations, conditions=None, vector=None):
    ...
    #np.save(f'b_eq.npy', b_eq)
    #np.save(f'c_eq.npy', c_eq)
...
if __name__ == "__main__":
    ...
    #python3 normalization.py --original_path ../labs/arboles_1000_head.csv  --modelo_path ../csvs/modelos\ 2.xlsx --regresion_path ../linear_regression/ciclo1_out.csv
